...
<head>
  ...
  <style>
        ...
        .chat-container {
            ...
            height: calc(100vh - 80px); /* Adjust to fit the page structure */
            background-color: #f8f9fa; /* Match your page's background color */
            border: 1px solid #e0e0e0; /* Match your page's border style */
            border-radius: 10px; /* Match your page's border radius */
            overflow: hidden; /* Ensure contents fit within the container */
        }
      ...
      <div class="container-fluid">
        <div class="card">
            <div class="chat-container">
                <div class="header">
                  Bienvenido al ChatBot de ESSALUD - Tacna
                </div>
                ...
                <div style="display: flex; justify-content: center; align-items: center">
                  <span style="display: none" id="barra">
                    <label><strong>--PROCESANDO SU CONSULTA AL CHATBOT--</strong></label><br/>
