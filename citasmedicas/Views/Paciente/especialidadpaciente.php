...
<head>
  ...
  <title>Especialidades - ESSALUD</title>
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <center>
                <h5 class="card-title fw-semibold mb-4"><strong>--Lista de Especialidades--</strong></h5>
              </center>
              <div class="row">
              <?php foreach ($especialidades as $especialidad): ?>
                <div class="col-md-4">
                  <div class="card">
                    <center>
                    <img src="../../assets/images/doctores/card_credential.svg" class="card-img-top" alt="..." style="width: 200px; height:200px">
                    </center>
                    <div class="card-body">                    
                      <center><h4 class="form-label text-center">Información de la Especialidad</h4></center>
                      <p class="card-text">Especialidad: <?php echo $especialidad['Nombre'];?></p>
                      <p class="card-text">Descripcion: <?php echo $especialidad['Descripcion'];?></p>       
                    </div>                    
                  </div>
                </div>
                <?php endforeach; ?>               
