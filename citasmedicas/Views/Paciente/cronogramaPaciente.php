    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <center>
                  <h5 class="card-title fw-semibold mb-4"><strong>--Horario de Atención--</strong></h5>
              </center>
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="card">
                    ...
                    <div class="card-body">                    
                      ...
                      <p class="card-text"><strong>Fecha de Atención: <?php echo $horario['FechaAtencion'];?></strong></p>
                      <p class="card-text"><strong>Inicio de Atención: <?php echo $horario['InicioAtencion'];?></strong></p>
                      <p class="card-text"><strong>Fin de Atención: <?php echo $horario['FinAtencion'];?></strong></p>                
                    </div>                    
                  </div>
                </div>
                <?php endforeach; ?>               
