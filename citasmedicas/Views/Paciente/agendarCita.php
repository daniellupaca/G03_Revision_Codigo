...
<body>
                ...
                <tbody>
                  ...
                  while ($row = $result->fetch_assoc()) {
                      echo "<tr>
                              ...
                              <td>" . $row['Estado'] . "</td>
                              <td>
                                <button type='button' class='btn btn-danger' data-bs-toggle='modal' data-bs-target='#cancelModal' data-cita-id='" . $row['ID'] . "'>
                                  Cancelar <br/>Cita Medica
                                </button>
                              </td>
                            </tr>";
                  }
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form id="cancelForm" action="../../Controller/CitasController.php" method="POST">
            <input type="hidden" name="cancelarCita" id="citaId">
  ...
  <script>
    // Detectar el botón de cancelación de cita para pasar el ID al formulario dentro del modal
