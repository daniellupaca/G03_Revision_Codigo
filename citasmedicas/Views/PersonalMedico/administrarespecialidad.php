                ...
                <div class="card-body">
                  <form action="../../Controller/EspecialidadController.php" method="POST">
                    <div class="mb-3">
                        ...
                        <select id="MedicoID" name="MedicoID" class="form-control">
                            ...
                            <table class="table text-nowrap mb-0 align-middle">
                                ...
                                <?php foreach ($especialidaddoctores as $especialidaddoctor): ?>
                                         <tr>
                                          ...
                                          <td> <button class="btn btn-primary detalle-button" data-especialidaddoctor='<?php echo json_encode($especialidaddoctor); ?>'>Editar Especialidad</button></td>
                                        </tr>
                                      <?php endforeach; ?>      
                                </tbody>
                            </table>
        ...
        <div class="modal-content">
            ...
            <form id="formEditarEspecialidad" action="../../Controller/EspecialidadController.php" method="POST">
                ...
                <input type="text" id="ID" name="ID" class="form-control" style="display: none;">
                    ...
                    <br/>
                      <center>
                        <label><strong>--ACTUALIZACION DE INFORMACIÓN--</strong></label>
                      </center>
                    <br/>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="FechaModificacion" name="FechaModificacion" require>
                    </div>
                    <div class="form-group">
                        <label for="Activo">Estado:</label>
                        <select class="form-control" id="Activo" name="Activo" require>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        detalleButtons.forEach(button => {
            button.addEventListener("click", function() {
                ...
                document.getElementById("FechaModificacion").value = especialidad.FechaModificacion;
                document.getElementById("Activo").value = especialidad.Activo;
