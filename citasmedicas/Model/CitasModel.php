...
class CitasModel {
    ...
    public function agendarCita($especialidadID, $medicoID, $pacienteID, $fecha, $hora) {
        ...
        if ($stmt->execute()) {
            echo "<script>
                    window.alert('Se programo correctamente su cita medica.');
                    window.location.href = '../Views/Paciente/agendarCita.php';
                  </script>";
            exit();
        } else {
            echo "<script>
                    window.alert('No se pudo agendar su cita medica.');
                    window.location.href = '../Views/Paciente/agendarCita.php';
                </script>";
        }
    }
